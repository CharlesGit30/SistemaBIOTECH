<?php
    ...
    $fazer->bind_param("sssssssss", $pac_nome, $pac_cpf, $pac_nasc, $med_nome, $med_crm, $data_atend, $cid, $conteudo_laudo, $prescricao);
       ...
       if($fazer->execute()){
          ...
          exit;
        } else { echo "Erro ao executar: " . $fazer->error;
        }
...
<h2 class="titulo_novolaudo">Novo Laudo Médico</h2>
        ...
        <div class="sessao">
            <div class="dados">
                <label>CPF:</label>
                <input type="text" name="pac_cpf" maxlength="11" placeholder="000.000.000-00">
            </div>
            <div class="dados">
        ...
        <button type="submit" name="enviar" class="novo">Salvar Laudo</button>
    </form>
</div>
